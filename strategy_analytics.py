...
class RealTradeAnalyticsManager:
    ...
    STRATEGY_REGISTRY = {
        "PULLBACK_DR_EKK": {
            ...
            "avg_rr": "1:2.0",
            "description": "กลยุทธ์จากหนังสือ #PullBack ร้อยล้าน (โดย พี่เอก / Trader Overseas): 3-Confluence (EMA 60 + Fib 38.2-61.8% + S/R Flip) + Trigger Pinbar/Engulfing แบ่งปิด TP1 กันทุน แล้วรันเทรนด์ด้วย EMA 60 Trailing Stop (ความเสี่ยง Step-Up 0.5% | TP 2.0R | รัน 24 ชม.)"
        },
        "RTM_M4_CONSERVATIVE": {
        ...
        "EW_WAVE3_BREAKER": {
            ...
            "avg_rr": "1:2.0",
            "description": "Elliott Wave 3 Flagship: ตามคลื่นส่ง Wave 3 หลังยืนยันการย่อ Wave 2 ไม่หลุดจุดเริ่ม Wave 1 (Rule 1) ทะลุ Breaker Block พร้อม EWO (5/34) ขยายตัวสูงสุด (ความเสี่ยง 1.0% | TP 2.0R)"
        },
        ...
        "RETIRED_SETUPS": {
            ...
            "magic_numbers": [777005, 777015, 777025, 777035, 777007, 777017, 777027, 777037, 555820, 555821, 555822, 555823, 555890, 555891, 555892, 555893, 666888, 666889, 666890, 555900, 555901, 555902, 555903, 555950, 555951, 555952, 555953],
            "avg_rr": "N/A",
            "description": "รวมประวัติและสถิติการเทรดของเซตอัพที่เลิกใช้งานแล้ว (AI Confluence Squeeze Breakout, News Momentum Expansion, Asian Range Sniper, RTM M5 All-Weather, RTM M7 Max Alpha, Captain SMC, TKT SMC, Flash Scalper ฯลฯ)"
        }
    }
